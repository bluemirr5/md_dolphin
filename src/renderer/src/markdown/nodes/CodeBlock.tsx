...
import { useActivePackId } from '../../store/theme-pack-store';
...
export function CodeBlock({ code, language }: CodeBlockProps): JSX.Element {
  ...
  // 사이클 12 R4: 활성 팩 id를 deps에 추가 — 팩 전환 시 재하이라이트 트리거
  // 가상 스크롤 환경에서 보이는 블록만 재실행됨 (off-screen은 unmount 후 다음 마운트에 재실행)
